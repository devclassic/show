import{r as y,c as V,a as d,b as j,d as l,w as s,t as f,F as g,o as b,e as z}from"./index-1kvfw-El.js";import{E,d as U}from"./el-form-item-B2rR_mOK.js";import{E as F}from"./el-input-CSxWa6D0.js";import{E as N,a as p,h as _}from"./el-message-BAv3Oocr.js";import{a as i}from"./asr-5o_LRsin.js";import{_ as k}from"./_plugin-vue_export-helper-DlAUqK2U.js";const T={class:"buttons"},v={class:"status"},R={key:0,class:"result"},S={__name:"Form",setup(B){const e=y({btnRecordText:"开始收音",status:"",result:"",form:{xm:"",nl:"",xb:"",sfzh:"",lxfs:"",zz:"",zs:"",jws:"",grjzs:""}});let u=!1;function w(){u?i.stop(async()=>{p.success("停止收音"),e.status="正在识别...",e.btnRecordText="开始收音",u=!1;const x=i.getWAVBlob(),t=new File([x],"audio.wav"),m=new FormData;m.append("file",t);let a=await _.post("/api/asr",m,{headers:{"Content-Type":"multipart/form-data"}});e.status="",e.result=a.data.data[0].text,e.status="正在处理...";const r=`
        <text>${e.result}</text>
        请分析<text>中的内容
