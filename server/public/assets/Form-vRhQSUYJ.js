import{r as y,c as V,a as d,b as j,d as l,w as s,t as f,F as g,o as b,e as z}from"./index-DFBKAQJf.js";import{E,d as N}from"./el-form-item-BXT43jCk.js";import{E as U}from"./el-input-Bt1zv1Kq.js";import{E as F,a as p,h as _}from"./http-DSFHMeZK.js";import{a as i}from"./asr-5o_LRsin.js";/* empty css                   */import{_ as k}from"./_plugin-vue_export-helper-DlAUqK2U.js";const S={class:"buttons"},T={class:"status"},v={key:0,class:"result"},R={__name:"Form",setup(B){const e=y({btnRecordText:"开始收音",status:"",result:"",form:{xm:"",nl:"",xb:"",sfzh:"",lxfs:"",zz:"",zs:"",jws:"",grjzs:""}});let u=!1;function w(){u?i.stop(async()=>{p.success("停止收音"),e.status="正在识别...",e.btnRecordText="开始收音",u=!1;const x=i.getWAVBlob(),t=new File([x],"audio.wav"),m=new FormData;m.append("file",t);let a=await _.post("/api/asr",m,{headers:{"Content-Type":"multipart/form-data"}});e.status="",e.result=a.data.data[0].text,e.status="正在处理...";const r=`
        <text>${e.result}</text>
        请分析<text>中的内容
